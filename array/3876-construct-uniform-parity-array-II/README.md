...
All elements are even, so the answer is `true`.
...
The solution and detailed explanation are available in [`NOTES.md`](./NOTES.md).

The JavaScript implementation is available in [`solution.js`](./solution.js).
